...
/**
 * A program that demonstrates the usage of the Collection implementations.
 * 
...
public class CollectionDemo {
	...
	/**
	 * Main method. Creates a few collections and performs some supported operations on them.
	 * 
	 * @param args Not used.
	 */
	public static void main(String[] args) {
		...
		col.remove(20); // removes 20 from collection (at position 0).
	}
}
