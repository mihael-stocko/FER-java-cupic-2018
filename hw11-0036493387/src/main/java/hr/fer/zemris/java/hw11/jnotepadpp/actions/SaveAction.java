 ...
 * to the disk. If the document does not yet exist on the disk, the user will be
 * asked for the path to a desired location.
 * 
...
public class SaveAction extends AbstractAction {
	 ...
	 * @param Main frame
	 */
	public SaveAction(String key, ILocalizationProvider lp, JNotepadPP frame, MultipleDocumentModel model) {
