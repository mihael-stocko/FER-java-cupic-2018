...
/**
 * This class represents an action that, when executed, sets the case of the selected text to uppercase.
 * 
 * @author Mihael Stočko
 *
 */
public class ToUpperCase extends AbstractAction {
	 ...
	 */
	public ToUpperCase(String key, ILocalizationProvider lp, MultipleDocumentModel model) {
