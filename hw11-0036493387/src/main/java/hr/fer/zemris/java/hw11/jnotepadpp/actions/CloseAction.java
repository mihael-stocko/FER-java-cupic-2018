...
/**
 * This class represents an action that, when executed, closes the currently opened document.
 * 
...
public class CloseAction extends AbstractAction {
	 ...
	 */
	public CloseAction(String key, ILocalizationProvider lp, MultipleDocumentModel model) {
