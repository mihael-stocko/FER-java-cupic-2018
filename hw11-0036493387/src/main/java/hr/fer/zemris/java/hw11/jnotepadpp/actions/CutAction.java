...
/**
 * This class represents an action that, when executed, cuts the selected part of the text
...
public class CutAction extends AbstractAction {
	 ...
	 * @param Clipboard
	 */
	public CutAction(String key, ILocalizationProvider lp, MultipleDocumentModel model, Clipboard clipboard) {
