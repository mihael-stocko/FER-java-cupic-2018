...
/**
 * This class represents an action that, when executed, changes the GUI language to Croatian.
 * 
 * @author Mihael Stočko
 *
 */
public class Croatian extends AbstractAction {
	 ...
	 */
	public Croatian(String key, ILocalizationProvider lp) {
