...
/**
 * This class represents an action that, when executed, pastes the text from the clipboard into
 * the opened document.
 * 
...
public class PasteAction extends AbstractAction {
	 ...
	 * @param Clipboard
	 */
	public PasteAction(String key, ILocalizationProvider lp, MultipleDocumentModel model, Clipboard clipboard) {
	...
	public void actionPerformed(ActionEvent arg0) {
		if(clipboard.getText().equals("")) return;
		...
		try {
			...
			doc.insertString(offset, clipboard.getText(), null);
