...
/**
 * This class represents an action that, when executed, lowers the case of the selected text.
 * 
 * @author Mihael Stočko
 *
 */
public class ToLowerCase extends AbstractAction {
	 ...
	 */
	public ToLowerCase(String key, ILocalizationProvider lp, MultipleDocumentModel model) {
