...
/**
 * This class represents an action that, when executed, changes the GUI language to English.
 * 
 * @author Mihael Stočko
 *
 */
public class English extends AbstractAction {
	 ...
	 */
	public English(String key, ILocalizationProvider lp) {
